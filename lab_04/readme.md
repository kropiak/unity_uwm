...
W [manualu](https://docs.unity3d.com/Manual/class-CharacterController.html) można znaleźć kilka wskazówek jak dostosować parametry komponentu do własnych potrzeb.
...
**Zadanie 4**  
Dodaj do skryptu ```LookAround``` ograniczenie obracania kamery do -90 i +90 stopni góra-dół (sprawdź metodę `Mathf.Clamp` (https://docs.unity3d.com/ScriptReference/Mathf.Clamp.html) z API Unity).